...
AbstractReport::addClassWithEmptyMainText — Adds a class with an empty [main text](https://github.com/lingtalfi/DocTools/blob/master/doc/api/Ling/DocTools/Info/CommentInfo.md#the-doc-comment-structure).
...
Source Code
===========
See the source code for method [AbstractReport::addClassWithEmptyMainText](/blob/master/Report/AbstractReport.php#L539-L547)
